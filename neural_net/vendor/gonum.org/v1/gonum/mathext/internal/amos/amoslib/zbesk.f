...
C                              I=1,...,N WHEN Xtr.GE.0.0. WHEN Xtr.LT.0.0
...
C         DNU AND DNU+1.0 IN THE RIGHT HALF PLANE Xtr.GE.0.0. FORWARD
...
C         CAN BE USED.
C
C         CBESK ASSUMES THAT A SIGNIFICANT DIGIT SINH(Xtr) FUNCTION IS
C         AVAILABLE.
C
